...
FOLD_JSON_PATH = FileDescriptor(
    name="Fold metadata JSON file",
    description="ProteinDJ JSON file containing metadata about the designed backbone structure",
    tool="ProteinDJ",
    key="proteindj|fold|fold_json_path",
)
...
FOLD_HELICES = NumericGlobalDescriptor(
    ...
    description="Number of alpha-helices in the generated fold.",
    tool="ProteinDJ",
...
FOLD_STRANDS = NumericGlobalDescriptor(
    ...
    description="Number of beta-strands in the generated fold.",
    tool="ProteinDJ",
...
FOLD_ROG = NumericGlobalDescriptor(
    ...
    description="Radius of gyration of fold generated by RFdiffusion, BindCraft, etc.",
    tool="ProteinDJ",
